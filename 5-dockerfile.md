...
```
docker run -d -P myapp:1.1

```

### ¿Con que puerto host se está realizando el mapeo?

#### EN EL PUERTO 80 configurado en el Dockerfile

**¿Qué es una imagen huérfana?**

#### Es una imagen que ya no tiene una etiqueta o referencia asociada. Esto suele ocurrir cuando construyes una nueva versión de una imagen y Docker elimina la etiqueta de la versión anterior, pero mantiene la imagen anterior sin etiquetar.
